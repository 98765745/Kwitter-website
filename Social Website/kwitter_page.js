...
function send()
{
      msg = document.getElementById("msg").nodeValuefirebase.database().ref(room_name).push({
name:user_name,
message:msg,
like:0
      });
...
like_button ="<button class='btn btn-warning' id="+firebase_message_id+" value="+like+" onclick='uploadLike(this.id)'>";
